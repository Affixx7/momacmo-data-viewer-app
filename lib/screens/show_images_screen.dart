...
import 'package:amplify_storage_s3/amplify_storage_s3.dart' as s3;
import 'package:flutter/material.dart';
import '../providers/s3_handler.dart';
...
class _SampleItemState extends State<SampleItem> {
  ...
  Widget build(BuildContext context) {
    ...
    final androidPathNumber =
        widget.imagePath.substring(widget.imagePath.length - 2);
    final androidPath = 'assets/$androidPathNumber.png';
